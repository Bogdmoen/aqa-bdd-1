...
public class MoneyTransferPage {
    ...
    public  void transferSum(int amount, int card) {
        card--;
    ...
    public void getWrongCardFieldAlert() {
        fieldAmount.setValue(String.valueOf(DataHelper.getValidSumForTransfer()));
    ...
    public void getEmptySumAlert(int card) {
        fieldFrom.setValue(DataHelper.getCardFor()[card].getNumber());
        transferButton.click();
        errorNotification.shouldBe(visible);
    ...
    public void getInsufficientBalanceAlert(int card, int amount) {
